...
class MovesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create move" do
    assert_difference('Move.count') do
      post moves_url, params: { move: { accepted: @move.accepted, game_id: @move.game_id, legal: @move.legal, move: @move.move } }
    end
  ...
  test "should update move" do
    patch move_url(@move), params: { move: { accepted: @move.accepted, game_id: @move.game_id, legal: @move.legal, move: @move.move } }
